...
define('CP_CALCULATEDFIELDSF_VERSION', '1.0.188' );
...
function cp_calculated_fields_form_check_posted_data() {
    ...
    if ( 'POST' == $_SERVER['REQUEST_METHOD'] && isset( $_POST['cp_calculatedfieldsf_post_options'] ) && is_admin() )
    {
		...
		{
			print($cpcff_main->public_form(array('id' => @intval($_POST['cp_calculatedfieldsf_id']))));
			wp_footer();
			wp_die('', __('Form Preview', 'calculated-fields-form'));
		}
		return;
    }
}
